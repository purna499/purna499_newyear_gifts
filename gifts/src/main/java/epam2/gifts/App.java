...
public class App
{
    public static void main( String[] args )
    {
        ...
        gift.add(choco1);
        Sweets choco2=new candy("Caramel","80%", 2,10);
        gift.add(choco2);
        Sweets choco3=new candy("Milk","20%", 8,20);
        gift.add(choco3);
        Sweets choco4=new Jellybeans("Crunchy","30%",5,20);
        gift.add(choco4);
        Sweets choco5=new candy("Toffey","60%",2,5);
        gift.add(choco5);
        Sweets choco6=new candy("Nuts","45%",6,4);
        gift.add(choco6);
